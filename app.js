...
var budgetController = (function () {
  ...
  return {
    ...
    calculateBudget: function () {
      //calculate totsl income and expenses
  ...
  return {
    ...
    addListItem: function (obj, type) {
      ...
      if (type === "income") {
        ...
        html =
          '<div class="item clearfix" id="expenses-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">0%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div></div>';
      }
    ...
    displayBudget: function (obj) {
      ...
      document.querySelector(DOMstrings.expensesLabel).textContent =
        formatNumber(obj.totalExpenses, "expenses");
